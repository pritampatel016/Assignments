...
public class TransferController {
	...
	public String addAccount(@Valid @RequestBody Account account, BindingResult br) throws AccountException{
		...
		String err="";
		if(br.hasErrors()) {
			List<FieldError> errors = (List<FieldError>) br.getFieldError();
	...
	public String transferAccount(@Valid @RequestBody TransferBean tbean, BindingResult br) throws AccountException
	{
		String err="";
		if(br.hasErrors()) {
